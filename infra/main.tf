...
resource "aws_ecs_capacity_provider" "capacity_provider" {
  ...
  auto_scaling_group_provider {
    auto_scaling_group_arn         = aws_autoscaling_group.asg_capacity_provider.arn
...
resource "aws_autoscaling_group" "asg_capacity_provider" {
  name                = var.asg-name
...
resource "aws_autoscaling_policy" "policy_up" {
  ...
  autoscaling_group_name = aws_autoscaling_group.asg_capacity_provider.name
}
...
resource "aws_cloudwatch_metric_alarm" "cpu_alarm_up" {
  ...
  dimensions = {
    AutoScalingGroupName = aws_autoscaling_group.asg_capacity_provider.name
  }
